...
pub static ELEMENT_ROLES: LazyLock<
    OrderedHashMap<AriaRoleRelationConcept, Vec<AriaRoleDefinitionKey>, RandomState>,
> = LazyLock::new(|| {
    let mut element_roles = OrderedHashMap::with_hasher(RandomState::new());
